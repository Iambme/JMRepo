...
*/
    ...
    public String updateUser(@PathVariable int id, @RequestParam String name, @RequestParam String login, @RequestParam String password) {
        myUserService.updateMyUser(id, name, login, password);
        return "redirect:/allUser";
